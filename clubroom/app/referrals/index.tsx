  ...
  if (c.status === 'error') {
    return (
      ...
      >
        ...
        <ErrorState
          message={c.error?.message || 'Failed to load referral data.'}
          onRetry={c.retry}
        />
      </SafeAreaView>
    );
        ...
        <>
          <Animated.View entering={FadeInDown.delay(100).springify()}>
            <View style={[styles.heroSection, { backgroundColor: withAlpha(palette.tint, 0.03) }]}>
              ...
              <ThemedText style={[styles.heroText, { color: palette.muted }]}>
                ...
                {c.referralCode && referralService.formatCredit(c.referralCode.creditAmount)} credit
          ...
          <Animated.View entering={FadeInDown.delay(300).springify()}>
            <ReferralHistory
              ...
              maxItems={5}
              onReferralPress={c.handleReferralPress}
            />
          </Animated.View>
