  ...
  return renderScreenShell(
    <>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={athlete.refreshing} onRefresh={athlete.onRefresh} />
        }
      >
              ...
              {analytics.activeGoals.slice(0, 2).map((goal, index) => (
                <AthleteGoalCard
                  ...
                  onComplete={(milestoneId) =>
                    athlete.handleCompleteMilestone(goal.id, milestoneId)
                  }
                />
              ))}
            </View>
                ...
                <Row gap="md" align="center">
                  ...
                  <Column flex>
                    ...
                    <ThemedText
                      style={[
                        Typography.caption,
                        { color: colors.muted, marginTop: Spacing.micro },
                      ]}
                    >
                      Completed{' '}
