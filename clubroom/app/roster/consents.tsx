        ...
        <View style={styles.loadingContainer}>
          {[1, 2, 3, 4].map((i) => (
            <View key={i} style={styles.skeletonCard}>
              <View style={styles.skeletonHeader}><Skeleton height={44} width={44} radius={22} />
                <View style={styles.skeletonInfo}><Skeleton height={16} width="60%" /><Skeleton height={12} width="40%" /></View>
              </View>
...
const styles = StyleSheet.create({
  ...
  statHeader: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xxs },
  statLabel: { ...Typography.caption, flex: 1 },
  statNumbers: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'space-between' },
  statPct: { ...Typography.heading },
  statDetail: { ...Typography.caption },
  searchSection: { flexDirection: 'row', gap: Spacing.sm, paddingHorizontal: Spacing.lg, marginBottom: Spacing.md },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.md, height: 44, borderRadius: Radii.md, gap: Spacing.xs },
