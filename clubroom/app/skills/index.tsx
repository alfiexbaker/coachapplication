    ...
    >
      ...
      <SurfaceCard style={styles.statsCard}>
        <Row align="center" justify="around">
          <View style={styles.statItem}>
            <ThemedText style={[Typography.display, { color: palette.tint }]}>
              {overallStats.totalUnlocked}
            </ThemedText>
            <ThemedText
          ...
          <View style={[styles.statDivider, { backgroundColor: palette.border }]} />
          <View style={styles.statItem}>
            <ThemedText style={[Typography.display, { color: palette.success }]}>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          message="Skill trees will appear here once progression data is available."
        />
      ) : (
      ...
      <SurfaceCard style={styles.infoCard}>
        ...
        <ThemedText style={[Typography.small, { color: palette.muted }]}>
          Complete training sessions and earn XP to unlock skills. Each skill has prerequisites that
          must be unlocked first. Unlocking skills awards badges and tracks your progression.
        </ThemedText>
