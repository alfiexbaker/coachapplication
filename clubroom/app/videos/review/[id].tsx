  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: palette.background }]} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Navigation controls */}
        <Row align="center" justify="space-between" style={[styles.navigationBar, { backgroundColor: palette.surface, borderColor: palette.border }]}>
...
const styles = StyleSheet.create({
  ...
  navButton: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs, borderRadius: Radii.md, borderWidth: 1 },
