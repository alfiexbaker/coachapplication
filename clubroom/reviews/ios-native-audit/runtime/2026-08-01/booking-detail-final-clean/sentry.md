...
No Sentry state was changed and no absence-of-error claim is inferred from the blocked readback. Runtime network and console assertions are recorded in `report.json`.
