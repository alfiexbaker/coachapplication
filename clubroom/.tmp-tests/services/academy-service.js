...
exports.academyService = {
    ...
    async discoverAcademies(filters) {
        try {
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to discover academies'));
        }
    },
    /**
     * Get academy by ID
    ...
    async getAcademy(academyId) {
        try {
            if (USE_MOCK) {
                academiesCache = await loadAcademies();
                return (0, result_1.ok)(academiesCache.find((a) => a.id === academyId) || null);
            }
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to load academy'));
        }
    },
    /**
     * Get academy by slug
    ...
    async getAcademyBySlug(slug) {
        try {
            if (USE_MOCK) {
                academiesCache = await loadAcademies();
                return (0, result_1.ok)(academiesCache.find((a) => a.slug === slug) || null);
            }
    ...
    async getUserAcademies(userId) {
        try {
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to load user academies'));
        }
    },
    /**
    ...
    async createAcademy(input) {
        try {
            ...
            if (USE_MOCK) {
                ...
                return (0, result_1.ok)(newAcademy);
            }
            const response = await fetch('/api/academies', {
                method: 'POST',
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to create academy'));
        }
    },
    /**
    ...
    async getStaff(academyId) {
        try {
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to load academy staff'));
        }
    },
    /**
    ...
    async createInvite(academyId, academyName, role, permissions, createdBy, createdByName, expiresInDays = 30, maxUses = 10) {
        try {
            ...
            return (0, result_1.err)((0, result_1.storageError)('Failed to create academy invite'));
        }
    },
    /**
    ...
    async hasPermission(academyId, userId, permission) {
        try {
            if (USE_MOCK) {
                ...
                return (0, result_1.ok)(membership.permissions.includes(permission));
            }
            const response = await fetch(`/api/academies/${academyId}/permissions/${userId}/${permission}`);
            const data = await response.json();
            return (0, result_1.ok)(data.hasPermission);
        }
        catch (error) {
            logger.error('Failed to check academy permission', error);
            return (0, result_1.err)((0, result_1.storageError)('Failed to check academy permission'));
        }
    },
    /**
     * Delete an academy
