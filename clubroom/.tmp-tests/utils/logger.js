...
class Logger {
    constructor() {
        this.context = {};
        this.configLevel = config_1.logging.level;
        this.consoleEnabled = config_1.logging.enableConsole;
        this.remoteEnabled = config_1.logging.enableRemote;
    }
    /**
 ...
 */
class ScopedLogger {
    constructor(parent, scope, _additionalContext) {
        this.parent = parent;
        this.scope = scope;
        this._additionalContext = _additionalContext;
    }
    prefix(message) {
