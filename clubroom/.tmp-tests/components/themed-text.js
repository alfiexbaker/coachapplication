...
function ThemedText({ style, lightColor, darkColor, type = 'default', ...rest }) {
    ...
    return (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: [{ color, fontFamily: theme_1.Fonts?.sans }, typeStyles[type], style], ...rest });
}
const styles = react_native_1.StyleSheet.create({
    ...
    link: {
        ...theme_1.Typography.base,
        // Link color is supplied by useThemeColor/lightColor/darkColor at runtime.
    },
    display: {
