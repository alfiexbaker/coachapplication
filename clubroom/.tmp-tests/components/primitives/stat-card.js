...
const styles = react_native_1.StyleSheet.create({
    ...
    label: { ...theme_1.Typography.caption, textTransform: 'uppercase', letterSpacing: 0.6 },
    labelCompact: { ...theme_1.Typography.small, textTransform: 'none', letterSpacing: 0, fontWeight: '400' },
    trendBadge: {
