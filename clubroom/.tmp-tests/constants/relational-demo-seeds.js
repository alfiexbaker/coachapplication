...
exports.CLUB_LIONS_ID = exports.RELATIONAL_DEMO_SEED_VERSION = void 0;
exports.buildRelationalDemoSeedPayload = buildRelationalDemoSeedPayload;
const coach_session_seeds_1 = require("@/constants/coach-session-seeds");
const DAY_MS = 24 * 60 * 60 * 1000;
exports.RELATIONAL_DEMO_SEED_VERSION = '2026-02-15-relational-v4-linked-group-density-plus';
exports.CLUB_LIONS_ID = 'club_lions';
function withOffset(dayOffset, hour, minute = 0) {
...
function buildCoachSessions() {
    const seedSessions = (0, coach_session_seeds_1.buildCoachSessionSeeds)();
    const extraSession = {
...
function buildBookingsFromSessions(sessions) {
...
function buildMessagesByThread() {
    return {
        thread_tom_coach1: [
            {
...
function buildChildrenProfiles() {
    return [
        {
            id: 'user1',
            parentId: 'user4',
...
function buildCoachBookings(offerings, bookings) {
...
function buildRelationalDemoSeedPayload() {
