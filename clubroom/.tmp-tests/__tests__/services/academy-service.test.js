...
(0, node_test_1.describe)('academyService', () => {
    ...
    (0, node_test_1.describe)('discoverAcademies', () => {
        (0, node_test_1.default)('returns public academies sorted by rating', async () => {
            const academies = expectOk(await academy_service_1.academyService.discoverAcademies());
    ...
    (0, node_test_1.describe)('getAcademy', () => {
        (0, node_test_1.default)('returns academy for known id', async () => {
            const academy = expectOk(await academy_service_1.academyService.getAcademy('academy_1'));
        ...
        (0, node_test_1.default)('returns null for unknown id', async () => {
            const result = expectOk(await academy_service_1.academyService.getAcademy(`unknown_${rid()}`));
    ...
    (0, node_test_1.describe)('getAcademyBySlug', () => {
        (0, node_test_1.default)('returns academy by slug', async () => {
            const academy = expectOk(await academy_service_1.academyService.getAcademyBySlug('east-london-fc'));
            strict_1.default.ok(academy);
            strict_1.default.equal(academy.slug, 'east-london-fc');
        });
        (0, node_test_1.default)('returns null for unknown slug', async () => {
            const result = expectOk(await academy_service_1.academyService.getAcademyBySlug(`no-slug-${rid()}`));
            strict_1.default.equal(result, null);
        });
    });
    // ---------------------------------------------------------------------------
    ...
    (0, node_test_1.describe)('createAcademy', () => {
        (0, node_test_1.default)('creates academy with correct fields', async () => {
            const academy = expectOk(await academy_service_1.academyService.createAcademy({
    ...
    (0, node_test_1.describe)('getStaff', () => {
        (0, node_test_1.default)('returns staff for known academy sorted by role', async () => {
            const staff = expectOk(await academy_service_1.academyService.getStaff('academy_1'));
    ...
    (0, node_test_1.describe)('createInvite', () => {
        (0, node_test_1.default)('creates invite with code', async () => {
            const invite = expectOk(await academy_service_1.academyService.createInvite('academy_1', 'East London FC Academy', 'COACH', ['CREATE_SESSIONS'], 'coach1', 'Marcus Thompson', 30, 5));
    ...
    (0, node_test_1.describe)('hasPermission', () => {
        (0, node_test_1.default)('owner has all permissions', async () => {
            const has = expectOk(await academy_service_1.academyService.hasPermission('academy_1', 'coach1', 'MANAGE_BILLING'));
            strict_1.default.equal(has, true);
        });
        (0, node_test_1.default)('coach only has assigned permissions', async () => {
            const has = expectOk(await academy_service_1.academyService.hasPermission('academy_1', 'coach_3', 'CREATE_SESSIONS'));
            strict_1.default.equal(has, true);
            const noHas = expectOk(await academy_service_1.academyService.hasPermission('academy_1', 'coach_3', 'MANAGE_BILLING'));
            strict_1.default.equal(noHas, false);
        });
        (0, node_test_1.default)('unknown user has no permissions', async () => {
            const has = expectOk(await academy_service_1.academyService.hasPermission('academy_1', `nobody_${rid()}`, 'CREATE_SESSIONS'));
