...
(0, node_test_1.describe)('clubService', () => {
    ...
    (0, node_test_1.describe)('canRemoveMembers', () => {
        ...
        (0, node_test_1.default)('MEMBER cannot remove', () => strict_1.default.equal(club_service_1.clubService.canRemoveMembers('MEMBER'), false));
    });
    (0, node_test_1.describe)('canBeRemoved', () => {
        (0, node_test_1.default)('OWNER cannot be removed', () => strict_1.default.equal(club_service_1.clubService.canBeRemoved('OWNER'), false));
    ...
    (0, node_test_1.describe)('canManageRole', () => {
        ...
        (0, node_test_1.default)('MEMBER cannot manage COACH', () => strict_1.default.equal(club_service_1.clubService.canManageRole('MEMBER', 'COACH'), false));
    });
