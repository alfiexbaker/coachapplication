...
export const NOTIFICATION_TYPES = {
  ...
  CARPOOL_ACCEPTED: 'carpool_accepted',
  CARPOOL_CANCELLED: 'carpool_cancelled',
...
export const NOTIFICATION_CATEGORY_MAP: Record<NotificationTypeValue, string> = {
  ...
  [NOTIFICATION_TYPES.CARPOOL_ACCEPTED]: 'booking',
  [NOTIFICATION_TYPES.CARPOOL_CANCELLED]: 'booking',
