  ...
  return [
    {
      ...
      skillsWorkedOn: ['Game Vision', 'Passing'],
      performanceRating: 4,
    ...
    },
    {
      ...
      skillsWorkedOn: ['Passing', 'Finishing'],
      performanceRating: 4,
    ...
    },
    {
      ...
      skillsWorkedOn: ['Game Vision', 'Dribbling & Skills'],
      performanceRating: 5,
    ...
    },
    {
      ...
      skillsWorkedOn: ['Pressing & Defending', 'Passing'],
      performanceRating: 4,
