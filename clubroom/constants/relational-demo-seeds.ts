...
export const RELATIONAL_DEMO_SEED_VERSION = '2026-02-15-relational-v4-linked-group-density-plus';
...
function buildBaseBookings(): Booking[] {
  return [
    ...
    },
    {
      ...
      serviceType: '1on1',
      objectives: ['Pressing', 'Recovery runs'],
      price: 58,
...
function buildOfferings(): SessionOffering[] {
  return [
    ...
    },
    {
      ...
      invitedAthleteNames: ['Tom Henderson', 'Emma Henderson', 'James Wilson'],
    },
    {
...
function buildInvites(): SessionInvite[] {
  return [
    ...
    },
    {
      ...
      sessionType: 'U15 Pressing Clinic',
      focus: 'Conditioning',
      notes: 'Both Grant siblings are invited to the same pressing clinic.',
      priceUsd: 25,
      duration: 75,
      status: 'PENDING',
      expiresAt: isoAt(7, 23, 59),
    ...
    },
    {
      ...
      sessionType: 'U15 Pressing Clinic',
      focus: 'Conditioning',
      notes: 'Ava is invited to join the full-squad pressing session.',
      priceUsd: 25,
      duration: 75,
      status: 'PENDING',
      expiresAt: isoAt(7, 23, 59),
    ...
    },
    {
      ...
      sessionType: 'U15 Pressing Clinic',
      focus: 'Conditioning',
      notes: 'Ward siblings invited together for the U15 pressing clinic.',
      priceUsd: 25,
      duration: 75,
      status: 'PENDING',
      expiresAt: isoAt(7, 23, 59),
...
function buildRoster(): RosterEntry[] {
  return [
    ...
    },
    {
      ...
      coachId: 'coach1',
      athleteId: 'athlete_5',
      athleteName: 'Ethan Cole',
      parentId: 'parent_4',
      parentName: 'Daniel Cole',
      status: 'PAUSED',
    ...
    },
    {
      ...
      coachId: 'coach1',
      athleteId: 'athlete_6',
      athleteName: 'Leo Grant',
      parentId: 'parent_5',
      parentName: 'Rachel Grant',
      status: 'ACTIVE',
      startDate: dateAt(-95),
    ...
    },
    {
      ...
      coachId: 'coach1',
      athleteId: 'athlete_9',
      athleteName: 'Liam Ward',
      parentId: 'parent_7',
      parentName: 'Hannah Ward',
      status: 'ACTIVE',
      startDate: dateAt(-68),
      lastSessionDate: dateAt(-5),
      nextSessionDate: dateAt(2),
  ...
  return {
    thread_tom_coach1: [
      ...
      },
      {
        ...
        threadId: 'thread_tom_coach1',
        sender: 'parent',
        body: 'Perfect, Tom is ready and we will arrive 10 minutes early.',
    ...
    thread_parent_user4_offering_u15_pressing: [
      {
        ...
        sender: 'coach',
        body: 'Tom and Emma both trained well. Shared clips are now in session media.',
    ...
    thread_parent_parent_5_offering_u15_pressing: [
      {
        ...
        sender: 'coach',
        body: 'Leo and Noah both attended. Pressing distances improved from last block.',
    ...
    thread_parent_parent_6_offering_u15_pressing: [
      {
        ...
        sender: 'coach',
        body: 'Ava had a strong session, especially compact shape during transitions.',
    ...
    thread_parent_parent_7_offering_u15_pressing: [
      {
        ...
        sender: 'coach',
        body: 'Liam and Zoe both attended. Shared clips show better pressing distances today.',
    ...
    reviews: [
      {
        ...
        content: 'Tom is playing with far more confidence and scanning more often.',
        comment: 'Tom is playing with far more confidence and scanning more often.',
        isPublic: true,
    ...
    coachPublicReviews: [
      {
        ...
        reviewerId: 'user4',
        rating: 5,
        comment: 'Sarah is brilliant with confidence and technical detail.',
      ...
      },
      {
        ...
        reviewerId: 'user5',
        rating: 5,
        comment: 'Mike brings excellent intensity and structure.',
  ...
  return [
    {
      id: 'coach1',
      name: 'Sarah Mitchell',
      bio: 'UEFA-qualified coach focused on high-performance youth development.',
      sports: ['Football'],
    ...
    },
    {
      id: 'coach2',
      name: 'Mike Thompson',
      bio: 'Former academy forward coaching finishing and movement patterns.',
      sports: ['Football'],
    ...
    },
    {
      id: 'coach3',
      name: 'David Roberts',
      bio: 'Development specialist for early-teen tactical understanding.',
      sports: ['Football'],
  ...
  return [
    {
      ...
      medicalConditions: [],
      medications: [],
      communicationNotes: 'Responds best to concise, visual instruction.',
      behavioralNotes: 'Highly competitive; use short refocus cues when frustrated.',
      emergencyContactName: 'John Henderson',
      emergencyContactPhone: '+44 7700 111001',
      emergencyContactRelation: 'Father',
      secondaryEmergencyName: 'Lisa Henderson',
    ...
    },
    {
      ...
      emergencyContactName: 'Rachel Grant',
    ...
    },
    {
      ...
      emergencyContactPhone: '+44 7700 333001',
      emergencyContactRelation: 'Mother',
      secondaryEmergencyName: 'Alex Grant',
    ...
    },
    {
      ...
      emergencyContactName: 'Hannah Ward',
