...
function buildCoachSessions(): Session[] {
  ...
  const extraSession: Session = {
    ...
    attendance: "ATTENDED",
    notes:
      "Strong pressing triggers. Keep improving body shape before tackling.",
...
function buildBaseBookings(): Booking[] {
  return [
    ...
    {
      id: "book22_child_user1_a_coach4",
      coachId: "coach4",
      athleteIds: ["child_user1_a"],
      athleteId: "child_user1_a",
      bookedById: "user4",
      status: "CONFIRMED",
      scheduledAt: isoAt(3, 16, 45),
      duration: 60,
      location: "Southbank 3G",
      notes: "Freya works on first touch and receiving angles.",
      coachName: "Maya Collins",
      service: "Junior First Touch Builder",
      serviceType: "1on1",
      objectives: ["First touch", "Passing"],
      price: 52,
      createdAt: isoAt(-2, 13, 10),
    },
    {
      id: "book23_child_user1_b_coach5",
      coachId: "coach5",
      athleteIds: ["child_user1_b"],
      athleteId: "child_user1_b",
      bookedById: "user4",
      status: "CONFIRMED",
      scheduledAt: isoAt(4, 18, 0),
      duration: 75,
      location: "Camden Power Cage",
      notes: "Luca in a defending + transition block.",
      coachName: "Elliot Hayes",
      service: "Defensive Recovery Lab",
      serviceType: "group",
      objectives: ["Defending", "Conditioning"],
      price: 39,
      createdAt: isoAt(-2, 13, 40),
      groupSessionId: "offering_coach5_transition_lab",
      groupRegistrationId: "reg_coach5_child_user1_b",
      isGroupSession: true,
      currentParticipants: 5,
      maxParticipants: 10,
    },
    {
      id: "book24_child_user1_a_completed",
      coachId: "coach4",
      athleteIds: ["child_user1_a"],
      athleteId: "child_user1_a",
      bookedById: "user4",
      status: "COMPLETED",
      scheduledAt: isoAt(-7, 16, 30),
      duration: 60,
      location: "Southbank 3G",
      notes: "Completed confidence + passing session.",
      coachName: "Maya Collins",
      service: "Junior First Touch Builder",
      serviceType: "1on1",
      objectives: ["Passing", "Composure"],
      price: 52,
      createdAt: isoAt(-10, 12, 10),
    },
    {
      id: "book25_child_user1_b_completed",
      coachId: "coach5",
      athleteIds: ["child_user1_b"],
      athleteId: "child_user1_b",
      bookedById: "user4",
      status: "COMPLETED",
      scheduledAt: isoAt(-9, 18, 0),
      duration: 75,
      location: "Camden Power Cage",
      notes: "Completed decision-speed session with group phase.",
      coachName: "Elliot Hayes",
      service: "Defensive Recovery Lab",
      serviceType: "group",
      objectives: ["Decision-Making", "Defending"],
      price: 39,
      createdAt: isoAt(-12, 12, 45),
      groupSessionId: "offering_coach5_transition_lab",
      groupRegistrationId: "reg_coach5_child_user1_b_completed",
      isGroupSession: true,
      currentParticipants: 6,
      maxParticipants: 10,
    },
    {
      id: "book26_user_no_kids_self",
      coachId: "coach6",
      athleteIds: ["user_no_kids"],
      athleteId: "user_no_kids",
      bookedById: "user_no_kids",
      status: "CONFIRMED",
      scheduledAt: isoAt(6, 12, 15),
      duration: 60,
      location: "Canary Drill Pod",
      notes: "Adult return-to-training technical block.",
      coachName: "Nina Duarte",
      service: "Lunch Break Technical Reset",
      serviceType: "1on1",
      objectives: ["Passing", "Conditioning"],
      price: 44,
      createdAt: isoAt(-1, 15, 30),
    },
    {
      id: "book27_parent_nokids_self",
      coachId: "coach7",
      athleteIds: ["parent_nokids"],
      athleteId: "parent_nokids",
      bookedById: "parent_nokids",
      status: "PENDING",
      scheduledAt: isoAt(8, 20, 0),
      duration: 60,
      location: "Stoke Newington Cage",
      notes: "Intro session inquiry from no-kids parent account.",
      coachName: "Omar Patel",
      service: "Foundations Intro Session",
      serviceType: "1on1",
      objectives: ["First touch"],
      price: 36,
      createdAt: isoAt(-1, 16, 0),
    },
  ];
}
...
function buildOfferings(): SessionOffering[] {
  return [
    ...
    {
      id: "offering_transition_game_lab",
      coachId: "coach1",
      clubId: CLUB_LIONS_ID,
      clubScope: "club",
      inviteType: "OPEN",
      title: "Transition Game Lab",
      description: "Fast transition games with immediate pressing triggers.",
      sessionType: "group",
      maxParticipants: 10,
      location: "Pitch 4",
      scheduledAt: isoAt(7, 18, 0),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "club",
      registrations: [
        {
          id: "reg_transition_user1",
          userId: "user1",
          bookedAt: isoAt(-1, 14, 0),
          status: "confirmed",
        },
        {
          id: "reg_transition_athlete7",
          userId: "athlete_7",
          bookedAt: isoAt(-1, 14, 15),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-3, 9, 30),
      duration: 70,
      price: 27,
      ageMin: 12,
      ageMax: 16,
      footballSkill: "Defending",
    },
    {
      id: "offering_weekend_combination_play",
      coachId: "coach1",
      clubId: CLUB_LIONS_ID,
      clubScope: "squad",
      squadId: "squad_u15",
      inviteType: "SQUAD_ONLY",
      title: "Weekend Combination Play",
      description: "Combination patterns into final-third finishes.",
      sessionType: "group",
      maxParticipants: 14,
      location: "Pitch 2",
      scheduledAt: isoAt(9, 19, 15),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "club",
      registrations: [
        {
          id: "reg_combination_user2",
          userId: "user2",
          bookedAt: isoAt(-1, 16, 0),
          status: "confirmed",
        },
        {
          id: "reg_combination_athlete8",
          userId: "athlete_8",
          bookedAt: isoAt(-1, 16, 10),
          status: "confirmed",
        },
        {
          id: "reg_combination_athlete10",
          userId: "athlete_10",
          bookedAt: isoAt(-1, 16, 20),
          status: "confirmed",
        },
      ],
      ...
      invitedAthleteIds: ["user2", "athlete_8", "athlete_10"],
      invitedAthleteNames: ["Maisie Barton", "Zara Hussain", "Tia Nguyen"],
    },
    {
      id: "offering_finishing_repetition_block",
      coachId: "coach1",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Finishing Repetition Block",
      description: "High-volume finishing reps and movement timing.",
      sessionType: "group",
      maxParticipants: 8,
      location: "Pitch 1",
      scheduledAt: isoAt(12, 17, 45),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "public",
      registrations: [
        {
          id: "reg_repetition_user3",
          userId: "user3",
          bookedAt: isoAt(-2, 13, 0),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-6, 10, 30),
      duration: 60,
      price: 29,
      ageMin: 12,
      ageMax: 16,
    ...
    },
    {
      ...
      description:
        "First-touch and passing detail for East London Eagles U14 athletes.",
      sessionType: "group",
      maxParticipants: 10,
      location: "East London Eagles Hub",
      scheduledAt: isoAt(6, 17, 30),
    ...
    {
      id: "offering_coach3_tactical_1on1",
      coachId: "coach3",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Tactical Awareness 1-to-1",
      description:
        "Positioning and scan-before-receive coaching for match realism.",
      sessionType: "1on1",
      maxParticipants: 1,
      location: "Brixton Performance Yard",
      scheduledAt: isoAt(2, 18, 45),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "public",
      registrations: [],
      createdAt: isoAt(-3, 13, 0),
      duration: 60,
      price: 42,
      ageMin: 12,
      ageMax: 18,
    ...
    {
      id: "offering_coach3_transition_small_group",
      coachId: "coach3",
      clubId: CLUB_LIONS_ID,
      clubScope: "club",
      inviteType: "OPEN",
      title: "Transition & Decision Small Group",
      description: "Compact-sided transition games with fast decision cues.",
      sessionType: "group",
      maxParticipants: 6,
      location: "Brixton Performance Yard",
      scheduledAt: isoAt(5, 18, 15),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "club",
      registrations: [
        {
          id: "reg_coach3_transition_athlete5",
          userId: "athlete_5",
          bookedAt: isoAt(-2, 18, 0),
          status: "confirmed",
        },
        {
          id: "reg_coach3_transition_athlete9",
          userId: "athlete_9",
          bookedAt: isoAt(-2, 18, 12),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-4, 9, 40),
      duration: 70,
      price: 30,
      ageMin: 12,
      ageMax: 17,
      footballSkill: "Defending",
      invitedAthleteIds: ["athlete_5", "athlete_9", "user3"],
      invitedAthleteNames: ["Finley Reeves", "Ollie Nguyen", "Kai Mensah"],
    },
    {
    ...
    {
      id: "offering_coach4_junior_tech",
      coachId: "coach4",
      clubId: CLUB_LIONS_ID,
      clubScope: "club",
      inviteType: "OPEN",
      title: "Junior Technical Fundamentals",
      description: "Ball mastery and first-touch habits for younger players.",
      sessionType: "group",
      maxParticipants: 10,
      location: "Southbank 3G",
      scheduledAt: isoAt(3, 16, 30),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "club",
      registrations: [
        {
          id: "reg_coach4_child_user1_a",
          userId: "child_user1_a",
          bookedAt: isoAt(-2, 11, 35),
          status: "confirmed",
        },
      ],
      ...
      invitedAthleteIds: ["child_user1_a", "user2"],
      invitedAthleteNames: ["Freya Barton", "Maisie Barton"],
    },
    {
      id: "offering_coach4_evening_strikers",
      coachId: "coach4",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Evening Strikers Circuit",
      description: "Finishing combinations under fatigue.",
      sessionType: "group",
      maxParticipants: 12,
      location: "Southbank 3G",
      scheduledAt: isoAt(7, 19, 30),
      isRecurring: false,
      recurrenceType: "none",
      status: "full",
      visibility: "public",
      registrations: [
        {
          id: "reg_coach4_evening_user3",
          userId: "user3",
          bookedAt: isoAt(-2, 18, 20),
          status: "confirmed",
        },
        {
          id: "reg_coach4_evening_athlete7",
          userId: "athlete_7",
          bookedAt: isoAt(-2, 18, 25),
          status: "confirmed",
        },
      ],
      offPlatformParticipants: 10,
      createdAt: isoAt(-8, 11, 0),
      duration: 75,
      price: 34,
      ageMin: 12,
      ageMax: 17,
    ...
    {
      id: "offering_coach5_transition_lab",
      coachId: "coach5",
      clubId: CLUB_LIONS_ID,
      clubScope: "squad",
      squadId: "squad_u15",
      inviteType: "SQUAD_ONLY",
      title: "Transition Defence Lab",
      description: "Recovery runs and compact shape under transitions.",
      sessionType: "group",
      maxParticipants: 10,
      location: "Camden Power Cage",
      scheduledAt: isoAt(4, 18, 0),
      ...
      registrations: [
        {
          id: "reg_coach5_child_user1_b",
          userId: "child_user1_b",
          bookedAt: isoAt(-2, 12, 5),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-7, 10, 45),
      duration: 75,
      price: 39,
      ageMin: 12,
      ageMax: 16,
      footballSkill: "Defending",
      invitedAthleteIds: ["child_user1_b", "athlete_6", "athlete_8"],
      invitedAthleteNames: ["Luca Barton", "Jayden Osei", "Zara Hussain"],
    },
    {
      id: "offering_coach5_weekend_reset",
      coachId: "coach5",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Weekend Match Prep Reset",
      description: "Saturday prep block for first touch + defensive focus.",
      sessionType: "1on1",
      maxParticipants: 1,
      location: "Regents Park Turf",
      scheduledAt: isoAt(9, 9, 30),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "public",
      registrations: [],
      createdAt: isoAt(-5, 9, 20),
      duration: 60,
      price: 47,
      ageMin: 12,
      ageMax: 18,
    ...
    {
      id: "offering_coach6_lunch_technical",
      coachId: "coach6",
      clubId: "club_eagles",
      clubScope: "public",
      inviteType: "OPEN",
      title: "Lunch Break Technical Reset",
      description: "Fast technical tune-up for athletes and adults.",
      sessionType: "1on1",
      maxParticipants: 1,
      location: "Canary Drill Pod",
      scheduledAt: isoAt(6, 12, 15),
      ...
      registrations: [
        {
          id: "reg_coach6_user_no_kids",
          userId: "user_no_kids",
          bookedAt: isoAt(-1, 15, 35),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-4, 13, 10),
      duration: 60,
      price: 44,
      ageMin: 14,
      ageMax: 40,
    ...
    {
      id: "offering_coach6_evening_composure_group",
      coachId: "coach6",
      clubId: "club_eagles",
      clubScope: "public",
      inviteType: "OPEN",
      title: "Evening Composure Small Group",
      description: "High-tempo composure and receiving work under pressure.",
      sessionType: "group",
      maxParticipants: 8,
      location: "Canary Drill Pod",
      scheduledAt: isoAt(8, 18, 45),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "public",
      registrations: [
        {
          id: "reg_coach6_evening_athlete4",
          userId: "athlete_4",
          bookedAt: isoAt(-1, 18, 0),
          status: "confirmed",
        },
        {
          id: "reg_coach6_evening_athlete6",
          userId: "athlete_6",
          bookedAt: isoAt(-1, 18, 6),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-4, 14, 0),
      duration: 70,
      price: 34,
      ageMin: 13,
      ageMax: 22,
      footballSkill: "Passing",
      invitedAthleteIds: ["athlete_4", "athlete_6", "user_no_kids"],
      invitedAthleteNames: ["Priya Kapoor", "Jayden Osei", "Mason Clarke"],
    },
    {
      id: "offering_coach7_intro",
      coachId: "coach7",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Foundations Intro Session",
      description: "Starter assessment for new athletes.",
      sessionType: "1on1",
      maxParticipants: 1,
      location: "Stoke Newington Cage",
      scheduledAt: isoAt(8, 20, 0),
    ...
    {
      id: "offering_coach8_trial_block",
      coachId: "coach8",
      clubId: CLUB_LIONS_ID,
      clubScope: "club",
      inviteType: "CLOSED",
      title: "Closed Trial Assessment",
      description: "Internal club trial block with invite-only access.",
      sessionType: "group",
      maxParticipants: 16,
      location: "West London Trials Arena",
      scheduledAt: isoAt(1, 10, 0),
      isRecurring: false,
      recurrenceType: "none",
      status: "cancelled",
      visibility: "club",
      registrations: [],
      createdAt: isoAt(-10, 9, 0),
      duration: 90,
      price: 0,
      ageMin: 13,
      ageMax: 17,
      footballSkill: "Conditioning",
      invitedAthleteIds: ["user2", "athlete_10"],
      invitedAthleteNames: ["Maisie Barton", "Tia Nguyen"],
    },
    {
      id: "offering_coach8_live_trial_prep",
      coachId: "coach8",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Live Trials Prep Circuit",
      description:
        "Assessment-ready prep block with pressing and conditioning phases.",
      sessionType: "group",
      maxParticipants: 14,
      location: "West London Trials Arena",
      scheduledAt: isoAt(6, 10, 30),
      isRecurring: false,
      recurrenceType: "none",
      status: "active",
      visibility: "public",
      registrations: [
        {
          id: "reg_coach8_live_user2",
          userId: "user2",
          bookedAt: isoAt(-1, 12, 10),
          status: "confirmed",
        },
        {
          id: "reg_coach8_live_athlete10",
          userId: "athlete_10",
          bookedAt: isoAt(-1, 12, 20),
          status: "confirmed",
        },
      ],
      createdAt: isoAt(-5, 8, 0),
      duration: 90,
      price: 33,
      ageMin: 13,
      ageMax: 18,
      footballSkill: "Conditioning",
      invitedAthleteIds: ["user2", "athlete_10", "athlete_8"],
      invitedAthleteNames: ["Maisie Barton", "Tia Nguyen", "Zara Hussain"],
    },
    {
      id: "offering_coach8_completed_camp",
      coachId: "coach8",
      clubId: CLUB_LIONS_ID,
      clubScope: "public",
      inviteType: "OPEN",
      title: "Completed Winter Development Camp",
      description:
        "Historical completed camp used for coverage of completed offerings.",
      sessionType: "group",
      maxParticipants: 20,
      location: "West London Indoor Dome",
      scheduledAt: isoAt(-14, 14, 0),
      isRecurring: false,
      recurrenceType: "none",
      status: "completed",
      visibility: "public",
      registrations: [
        {
          id: "reg_coach8_completed_athlete9",
          userId: "athlete_9",
          bookedAt: isoAt(-20, 12, 0),
          status: "completed",
        },
      ],
      createdAt: isoAt(-25, 11, 0),
      duration: 120,
      price: 20,
      ageMin: 12,
      ageMax: 17,
      footballSkill: "Conditioning",
      offPlatformParticipants: 7,
    },
  ];
}
function buildInvites(): SessionInvite[] {
  return [
    ...
    },
    {
      ...
      focus: "Distribution",
      notes: "Declined by parent due to a school pick-up clash.",
      price: 55,
      duration: 60,
      status: "DECLINED",
...
function buildRoster(): RosterEntry[] {
  return [
      ...
      notes: [
        {
          ...
          content:
            "Needs better first-step reactions when pressing from blind side.",
    ...
    {
      id: "roster_coach4_child_user1_a",
      coachId: "coach4",
      athleteId: "child_user1_a",
      athleteName: "Freya Barton",
      parentId: "user4",
      parentName: "Chris Barton",
      status: "ACTIVE",
      startDate: dateAt(-60),
      lastSessionDate: dateAt(-7),
      nextSessionDate: dateAt(3),
      totalSessions: 9,
      totalRevenue: 468,
      averageRating: 4.3,
      notes: [
        {
          id: "roster_note_child_user1_a_1",
          content: "Quick confidence gains in first-touch receiving drills.",
          createdAt: isoAt(-7, 17, 15),
        },
      ],
      tags: ["u12", "first-touch"],
      primaryFocus: "Dribbling",
      notificationPreference: "ALL",
    },
    {
      id: "roster_coach5_child_user1_b",
      coachId: "coach5",
      athleteId: "child_user1_b",
      athleteName: "Luca Barton",
      parentId: "user4",
      parentName: "Chris Barton",
      status: "ACTIVE",
      startDate: dateAt(-55),
      lastSessionDate: dateAt(-9),
      nextSessionDate: dateAt(4),
      totalSessions: 8,
      totalRevenue: 390,
      averageRating: 4.2,
      notes: [
        {
          id: "roster_note_child_user1_b_1",
          content: "Strong recovery effort in transition games.",
          createdAt: isoAt(-9, 18, 10),
        },
      ],
      tags: ["u13", "defending"],
      primaryFocus: "Defending",
    ...
    {
      id: "roster_coach6_user_no_kids",
      coachId: "coach6",
      athleteId: "user_no_kids",
      athleteName: "Mason Clarke",
      parentId: "user_no_kids",
      parentName: "Mason Clarke",
      status: "ACTIVE",
      startDate: dateAt(-20),
      lastSessionDate: dateAt(-2),
      nextSessionDate: dateAt(6),
      totalSessions: 4,
      totalRevenue: 176,
      averageRating: 4.0,
      notes: [
        {
          id: "roster_note_user_no_kids_1",
          content:
            "Returning adult player, responds well to short technical blocks.",
          createdAt: isoAt(-2, 12, 40),
        },
      ],
      tags: ["adult", "returning-player"],
      primaryFocus: "Passing",
      notificationPreference: "IMPORTANT",
    },
  ];
...
function buildFavourites(): FavouriteCoach[] {
  return [
    ...
    },
    {
      ...
      coachId: "coach4",
      isFavourite: true,
      createdAt: isoAt(-8, 9, 10),
    },
    {
      id: "fav_user_club_linked_coach5",
      userId: "user_club_linked",
      coachId: "coach5",
      isFavourite: true,
      createdAt: isoAt(-5, 10, 5),
    },
  ];
}
    ...
    reviews: [
      {
        ...
        content:
          "Alfie is playing with far more confidence and scanning more often.",
        comment:
          "Alfie is playing with far more confidence and scanning more often.",
        isPublic: true,
      ...
      },
      {
        ...
        content:
          "Clear structure, direct feedback, and very practical coaching.",
        comment:
          "Clear structure, direct feedback, and very practical coaching.",
        isPublic: true,
        isVerifiedBooking: true,
...
function buildCoaches(): CoachDirectoryEntry[] {
  return [
    ...
    },
    {
      id: "coach4",
      name: "Maya Collins",
      bio: "Youth technical coach focused on confidence-first first-touch development.",
      sports: ["Football"],
      location: {
        city: "London",
        state: "Greater London",
      ...
      joinedAt: "2022-05-04",
      totalSessions: 241,
      nextAvailable: isoAt(3, 16, 30),
      badges: ["Verified", "DBS Checked"],
      footballFocuses: ["First Touch", "Passing", "Confidence"],
      qualifications: ["UEFA C Licence", "FA Youth Module"],
      yearsExperience: 6,
      dbsChecked: true,
    },
    {
      id: "coach5",
      name: "Elliot Hayes",
      bio: "Transition and defensive detail specialist for U13-U16 athletes.",
      sports: ["Football"],
      location: {
        city: "London",
        state: "Greater London",
      ...
      joinedAt: "2023-01-18",
      totalSessions: 164,
      nextAvailable: isoAt(4, 18, 0),
      badges: ["Verified"],
      footballFocuses: ["Defending", "Transition", "Conditioning"],
      qualifications: ["UEFA C Licence"],
      yearsExperience: 5,
      dbsChecked: true,
    },
    {
      id: "coach6",
      name: "Nina Duarte",
      bio: "Compact lunchtime technical sessions for busy athletes and returners.",
      sports: ["Football"],
      location: {
        city: "London",
        state: "Greater London",
      ...
      joinedAt: "2023-08-12",
      totalSessions: 97,
      nextAvailable: isoAt(6, 12, 15),
      badges: ["Verified"],
      footballFocuses: ["Passing", "Composure", "Recovery Runs"],
    ...
    },
    {
      id: "coach7",
      name: "Omar Patel",
      bio: "Intro pathway coach helping new players build fundamentals safely.",
      sports: ["Football"],
      location: {
        city: "London",
        state: "Greater London",
      ...
      joinedAt: "2024-02-01",
      totalSessions: 58,
      nextAvailable: isoAt(8, 20, 0),
      badges: ["Verified"],
      footballFocuses: ["First Touch", "Movement", "Confidence"],
      qualifications: ["FA Level 2", "Safeguarding For Coaches"],
      yearsExperience: 3,
      dbsChecked: true,
    },
    {
      id: "coach8",
      name: "Harriet Lowe",
      bio: "Club trials and assessment lead with selective invite-only blocks.",
      sports: ["Football"],
      location: {
        city: "London",
        state: "Greater London",
      ...
      joinedAt: "2021-11-09",
      totalSessions: 356,
      nextAvailable: isoAt(10, 10, 0),
      badges: ["Verified", "Top Rated"],
      footballFocuses: ["Conditioning", "Assessment", "Pressing"],
      qualifications: ["UEFA B Licence", "FA Talent ID"],
      yearsExperience: 9,
      dbsChecked: true,
    },
  ];
...
function buildClubMembers(): ClubMemberSeed[] {
  return [
    ...
    },
    {
      ...
      bannedAt: dateAt(-4),
      bannedBy: "coach1",
      banReason: "Safeguarding suspension pending review.",
    },
    {
      userId: "coach8",
      userName: "Harriet Lowe",
      role: "COACH",
      status: "active",
      joinedAt: dateAt(-260),
      squadIds: ["squad_u15"],
  ...
  return [
    {
      ...
      disabilities: [
        {
          ...
          supportRequired:
            "Short instructions, regular movement breaks, positive reinforcement",
      ...
      specialNeeds: [
        {
          ...
          description:
            "Needs clear advance warnings before changing activities",
          severity: "MODERATE" as const,
          accommodationsNeeded: [
            "5-minute verbal warning",
            "Visual timer",
            "Quiet space for breaks",
          ],
          parentHints:
            "Give a 5-minute warning before transitions. Let him finish what he is doing.",
        },
      ],
      ...
      communicationNotes:
        "Responds best to concise, visual instruction. Prefers one step at a time.",
      behavioralNotes:
        "Highly competitive; use short refocus cues when frustrated. May need movement breaks every 20 minutes.",
    ...
    },
    {
      ...
      medications: [],
      communicationNotes:
        "Build confidence with clear praise and one-step prompts.",
      behavioralNotes:
        "May be quiet initially; warms up quickly after first few reps.",
      emergencyContactName: "Chris Barton",
      emergencyContactPhone: "+44 7700 111001",
      emergencyContactRelation: "Father",
      secondaryEmergencyName: "Sarah Barton",
    ...
    },
    {
      ...
      communicationNotes:
        "Prefers tactical context before technical instruction.",
    ...
    },
    {
      ...
      medications: [],
      communicationNotes:
        "Responds well to visual demos and quick checkpoints.",
      behavioralNotes: "Builds confidence quickly after first success.",
      emergencyContactName: "Alfie Barton",
      emergencyContactPhone: "+44 7700 666001",
      emergencyContactRelation: "Father",
      secondaryEmergencyName: "Chris Barton",
      secondaryEmergencyPhone: "+44 7700 111001",
      photoConsent: true,
      videoConsent: true,
      socialMediaConsent: false,
      emergencyTreatmentConsent: true,
      createdAt: isoAt(-90, 10, 25),
      updatedAt: isoAt(-2, 16, 0),
    },
    {
      id: "child_user1_b",
      parentId: "user4",
      ...
      specialNeeds: [
        {
          id: "sn-seed-user1-b",
          category: "LEARNING",
          name: "Short instruction sets",
          description:
            "Performs best with one-step instruction and immediate repeat.",
          severity: "MILD",
          accommodationsNeeded: [
            "Single-step drill cues",
            "Demonstration before execution",
          ],
          parentHints:
            "Confirm understanding with one quick question before starting.",
        },
      ],
      hasSpecialNeeds: true,
      allergies: [],
      ...
      medications: [],
      communicationNotes:
        "Short coaching cues and check-backs improve outcomes.",
      behavioralNotes: "Needs clear transitions between drill blocks.",
      emergencyContactName: "Alfie Barton",
      emergencyContactPhone: "+44 7700 666001",
      emergencyContactRelation: "Father",
      secondaryEmergencyName: "Chris Barton",
      ...
      socialMediaConsent: true,
      emergencyTreatmentConsent: true,
      createdAt: isoAt(-88, 10, 30),
      updatedAt: isoAt(-2, 16, 5),
    },
    {
      id: "athlete_6",
      parentId: "parent_5",
    ...
    },
    {
      ...
      medications: [],
      communicationNotes:
        "Clear verbal prompts and single-focus tasks work best.",
      behavioralNotes:
        "Confidence rises quickly after first successful repetition.",
      emergencyContactName: "Vanessa Osei",
      emergencyContactPhone: "+44 7700 333001",
      emergencyContactRelation: "Mother",
    ...
    },
    {
      ...
      medications: [],
      communicationNotes:
        "Short tactical prompts land best during live drills.",
    ...
    },
    {
      ...
      medications: [],
      communicationNotes:
        "Benefits from clear one-step targets per drill block.",
...
function buildFamilyBookings(): FamilyCalendarEvent[] {
  return [
    ...
    },
    {
      ...
      colorCode: "#6366F1",
      title: "Junior Technical Fundamentals",
      description: "Freya first-touch and confidence reps",
      start: isoAt(3, 16, 30),
      end: isoAt(3, 17, 30),
      location: "Southbank 3G",
      coachId: "coach4",
    ...
    {
      id: "family_booking_10",
      childId: "child_user1_b",
      colorCode: "#22C55E",
      title: "Transition Defence Lab",
      description: "Luca transition defence and recovery runs",
      start: isoAt(4, 18, 0),
      end: isoAt(4, 19, 15),
      location: "Camden Power Cage",
      coachId: "coach5",
...
function buildCoachBookings(
  offerings: SessionOffering[],
  bookings: Booking[],
): CoachBookingSeed[] {
  const offeringRows: CoachBookingSeed[] = offerings.flatMap((offering) =>
    new Date(offering.scheduledAt) > new Date()
      ? [
          {
            id: offering.id,
            ...
            currentAthletes:
              offering.registrations.filter((r) => r.status === "confirmed")
                .length + (offering.offPlatformParticipants ?? 0),
  ...
  const bookingRows: CoachBookingSeed[] = bookings.flatMap((booking) =>
      ...
      ? [
          {
            ...
            maxAthletes: 1,
            currentAthletes:
              booking.athleteIds?.length ?? (booking.athleteId ? 1 : 0),
            athleteIds:
              booking.athleteIds ??
              (booking.athleteId ? [booking.athleteId] : []),
