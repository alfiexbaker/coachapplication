...
function buildOfferings(): SessionOffering[] {
  return [
    ...
    },
    {
      ...
      description: 'Positioning and scan-before-receive coaching for match realism.',
      sessionType: '1on1',
      maxParticipants: 1,
    ...
    },
    {
      ...
      description: 'Assessment-ready prep block with pressing and conditioning phases.',
      sessionType: 'group',
      maxParticipants: 14,
      location: 'West London Trials Arena',
    ...
    },
    {
      ...
      description: 'Historical completed camp used for coverage of completed offerings.',
      sessionType: 'group',
      maxParticipants: 20,
      ...
      notes: [
        {
          ...
          content: 'Returning adult player, responds well to short technical blocks.',
...
function buildCoaches(): CoachDirectoryEntry[] {
  return [
    ...
    },
    {
      ...
      sports: ['Football'],
      location: { city: 'London', state: 'Greater London', lat: 51.502, lng: -0.071 },
      distance: 2.9,
      rating: 4.7,
      reviewCount: 29,
      minPrice: 26,
    ...
    },
    {
      ...
      sports: ['Football'],
      location: { city: 'London', state: 'Greater London', lat: 51.541, lng: -0.143 },
      distance: 4.4,
      rating: 4.6,
      reviewCount: 21,
      minPrice: 34,
    ...
    },
    {
      ...
      sports: ['Football'],
      location: { city: 'London', state: 'Greater London', lat: 51.504, lng: -0.02 },
      distance: 6.1,
      rating: 4.5,
      reviewCount: 17,
      minPrice: 40,
    ...
    },
    {
      ...
      sports: ['Football'],
      location: { city: 'London', state: 'Greater London', lat: 51.565, lng: -0.072 },
      distance: 5.8,
      rating: 4.4,
      reviewCount: 12,
      minPrice: 32,
    ...
    },
    {
      ...
      sports: ['Football'],
      location: { city: 'London', state: 'Greater London', lat: 51.511, lng: -0.264 },
      distance: 7.2,
      rating: 4.8,
      reviewCount: 41,
      minPrice: 0,
...
function buildChildrenProfiles(): ChildProfileSeed[] {
  return [
    ...
    },
    {
      ...
      medicalConditions: [],
      medications: [],
      communicationNotes: 'Responds well to visual demos and quick checkpoints.',
    ...
    },
    {
      ...
      specialNeeds: [
        {
          ...
          description: 'Performs best with one-step instruction and immediate repeat.',
          severity: 'MILD',
          accommodationsNeeded: ['Single-step drill cues', 'Demonstration before execution'],
          parentHints: 'Confirm understanding with one quick question before starting.',
        },
      ],
      hasSpecialNeeds: true,
      allergies: [],
      medicalConditions: [],
      medications: [],
      communicationNotes: 'Short coaching cues and check-backs improve outcomes.',
...
function buildCoachBookings(offerings: SessionOffering[], bookings: Booking[]): CoachBookingSeed[] {
  const offeringRows: CoachBookingSeed[] = offerings
    .filter((offering) => new Date(offering.scheduledAt) > new Date())
    .map((offering) => ({
      id: offering.id,
      ...
      currentAthletes:
        offering.registrations.filter((r) => r.status === 'confirmed').length +
        (offering.offPlatformParticipants ?? 0),
