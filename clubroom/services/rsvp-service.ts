...
const MOCK_RSVPS: SessionRsvp[] = [
  // ── Half-Term Football Camp (gs_1) — 12 registered, varied responses ──
  {
    id: 'rsvp_gs1_01',
    sessionId: 'gs_1',
    userId: 'user_parent_01',
    childId: 'user1',
    status: 'going',
    respondedAt: '2026-01-07T08:00:00Z',
  ...
  },
  {
    ...
    childId: 'user2',
    status: 'going',
    respondedAt: '2026-01-07T08:05:00Z',
  ...
  },
  {
    ...
    childId: 'user3',
    status: 'maybe',
    respondedAt: '2026-01-08T09:00:00Z',
  ...
  },
  {
    ...
    childId: 'user4a',
    status: 'going',
    respondedAt: '2026-01-08T10:00:00Z',
  ...
  },
  {
    ...
    childId: 'user5',
    status: 'not_going',
    respondedAt: '2026-01-09T12:00:00Z',
  ...
  },
  {
    ...
    childId: 'user7',
    status: 'going',
    respondedAt: '2026-01-10T14:00:00Z',
  ...
  // parent1 (user4) RSVPs for Tom + Emma on gs_1
  {
    ...
    childId: 'user1',
    status: 'going',
    respondedAt: '2026-01-07T07:00:00Z',
  ...
  // ── Striker Masterclass (gs_2) — 8 registered, mostly responded ──
  {
    ...
    childId: 'user1',
    status: 'going',
    respondedAt: '2026-01-10T08:00:00Z',
    createdAt: '2026-01-09T10:00:00Z',
  },
  {
    id: 'rsvp_gs2_02',
  ...
  },
  {
    ...
    childId: 'user6',
    status: 'maybe',
    respondedAt: '2026-01-11T08:00:00Z',
  ...
  },
  {
    ...
    childId: 'user9',
    status: 'going',
    respondedAt: '2026-01-11T10:00:00Z',
  ...
  // parent1 (user4) RSVP for Tom on gs_2
  {
    ...
    childId: 'user1',
    status: 'maybe',
    respondedAt: '2026-01-10T07:00:00Z',
  ...
  // parent1 (user4) RSVP for Emma on gs_3
  {
    ...
    childId: 'user2',
    status: 'going',
    respondedAt: '2026-01-12T07:00:00Z',
  ...
  // ── Free Trial (gs_4) — mixed responses ──
  {
    ...
    childId: 'user4a',
    status: 'going',
    respondedAt: '2026-01-13T10:00:00Z',
  ...
  // ── U11 Training (gs_training_1) — 6 registered, good response rate ──
  {
    ...
    childId: 'user1',
    status: 'going',
    respondedAt: '2026-01-13T08:00:00Z',
  ...
  },
  {
    ...
    childId: 'user3',
    status: 'maybe',
    respondedAt: '2026-01-14T08:00:00Z',
  ...
  },
  {
    ...
    childId: 'user4a',
    status: 'going',
    respondedAt: '2026-01-14T09:00:00Z',
  ...
  },
  {
    ...
    childId: 'user5',
    status: 'not_going',
    respondedAt: '2026-01-14T10:00:00Z',
  ...
  },
  {
    ...
    childId: 'user6',
    status: 'going',
    respondedAt: '2026-01-14T11:00:00Z',
...
export const rsvpService = {
  ...
  async sendReminder(sessionId: string): Promise<void> {
    ...
    await Promise.all(
      pending.map((rsvp) =>
        notificationTriggers.groupSessionCreated(
          'RSVP Reminder',
  ...
  async getBatchCounts(
    ...
    const result = new Map<
      string,
      { going: number; notGoing: number; maybe: number; pending: number }
    >();
