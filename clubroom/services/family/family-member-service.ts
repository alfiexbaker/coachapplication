...
class FamilyMemberService {
  ...
  async getById(childId: string): Promise<Result<FamilyMember, ServiceError>> {
    try {
      ...
      return err(storageError('Failed to retrieve family member'));
    }
  }
  ...
  async create(
    ...
    try {
      ...
      return err(storageError('Failed to create family member'));
    }
  }
  ...
  async update(
    ...
    try {
      ...
      return err(storageError('Failed to update family member'));
    }
  }
