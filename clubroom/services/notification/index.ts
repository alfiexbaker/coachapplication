...
export const notificationServices = {
  ...
  notifyCoachNewBooking:
    notificationSenderService.notifyCoachNewBooking.bind(notificationSenderService),
  notifyCoachBookingCancelled:
    notificationSenderService.notifyCoachBookingCancelled.bind(notificationSenderService),
  notifyCoachInviteAccepted:
    notificationSenderService.notifyCoachInviteAccepted.bind(notificationSenderService),
  notifyCoachInviteDeclined:
    notificationSenderService.notifyCoachInviteDeclined.bind(notificationSenderService),
  notifyCoachNewMessage:
    notificationSenderService.notifyCoachNewMessage.bind(notificationSenderService),
  notifyCoachNewReview:
    notificationSenderService.notifyCoachNewReview.bind(notificationSenderService),
  notifyCoachSessionReminder:
    notificationSenderService.notifyCoachSessionReminder.bind(notificationSenderService),
  ...
  notifyParentBadgeAwarded:
    notificationSenderService.notifyParentBadgeAwarded.bind(notificationSenderService),
  notifyParentSessionFeedback:
    notificationSenderService.notifyParentSessionFeedback.bind(notificationSenderService),
  notifyParentNewMessage:
    notificationSenderService.notifyParentNewMessage.bind(notificationSenderService),
  notifyParentSessionReminder:
    notificationSenderService.notifyParentSessionReminder.bind(notificationSenderService),
  notifyParentClubPost:
    notificationSenderService.notifyParentClubPost.bind(notificationSenderService),

  // Preferences operations
  getPreferences: notificationPreferencesService.getPreferences.bind(
    notificationPreferencesService,
  ),
  updatePreferences: notificationPreferencesService.updatePreferences.bind(
    notificationPreferencesService,
  ),
  setQuietHours: notificationPreferencesService.setQuietHours.bind(notificationPreferencesService),
  toggleQuietHours: notificationPreferencesService.toggleQuietHours.bind(
    notificationPreferencesService,
  ),
  toggleChannel: notificationPreferencesService.toggleChannel.bind(notificationPreferencesService),
  toggleNotificationType: notificationPreferencesService.toggleNotificationType.bind(
    notificationPreferencesService,
  ),
  setNotificationTypeChannels: notificationPreferencesService.setNotificationTypeChannels.bind(
    notificationPreferencesService,
  ),
  ...
  getMutedCoaches: notificationPreferencesService.getMutedCoaches.bind(
    notificationPreferencesService,
  ),
  isCoachMuted: notificationPreferencesService.isCoachMuted.bind(notificationPreferencesService),
  isInQuietHours: notificationPreferencesService.isInQuietHours.bind(
    notificationPreferencesService,
  ),
  shouldSendNotification: notificationPreferencesService.shouldSendNotification.bind(
    notificationPreferencesService,
  ),
  resetPreferences: notificationPreferencesService.resetPreferences.bind(
    notificationPreferencesService,
  ),
};
