...
const MOCK_TRANSACTIONS: WalletTransaction[] = [
  ...
  },
  {
    ...
    currency: 'GBP',
    status: 'COMPLETED',
    description: '1-on-1 session with Coach Jess Okafor',
    reference: 'booking_001',
    balanceAfter: 50.0,
    createdAt: '2024-07-10T15:30:00.000Z',
    completedAt: '2024-07-10T15:30:01.000Z',
    metadata: { coachId: 'coach1', coachName: 'Jess Okafor', sessionType: '1-on-1' },
  },
  {
    id: 'txn_p1_3',
    walletId: 'wallet_parent1',
  ...
  },
  {
    ...
    metadata: { coachId: 'coach2', coachName: 'Reuben Carr', sessionType: 'group' },
  },
  {
    id: 'txn_p1_5',
    walletId: 'wallet_parent1',
  ...
  },
  {
    ...
    currency: 'GBP',
    status: 'COMPLETED',
    description: '1-on-1 session with Coach Aiden Sharma',
    reference: 'booking_010',
    balanceAfter: 55.0,
    createdAt: '2024-09-15T13:00:00.000Z',
    completedAt: '2024-09-15T13:00:01.000Z',
    metadata: { coachId: 'coach3', coachName: 'Aiden Sharma', sessionType: '1-on-1' },
  },
  {
    id: 'txn_p2_3',
    walletId: 'wallet_parent2',
  ...
  },
  {
    ...
    metadata: { coachId: 'coach1', coachName: 'Jess Okafor', sessionType: 'group' },
  },
  {
    id: 'txn_p2_5',
    walletId: 'wallet_parent2',
