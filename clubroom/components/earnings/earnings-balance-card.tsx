  ...
  return (
    <SurfaceCard style={styles.card}>
      ...
      <Clickable onPress={onWithdraw}>
        <View style={[styles.withdrawBtn, { backgroundColor: palette.tint }]}>
...
const styles = StyleSheet.create({
  ...
  withdrawBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.xs, paddingVertical: Spacing.sm, borderRadius: Radii.md, marginTop: Spacing.xs },
});
