  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <Clickable
          style={[styles.backdrop, { backgroundColor: withAlpha(colors.text, 0.5) }]}
          onPress={onClose}
        />
              ...
              <>
                ...
                <Row gap="sm" align="flex-start">
                  ...
                  <View style={styles.titleContainer}>
                    ...
                    >
                      <ThemedText style={[Typography.caption, { color: tree.themeColor }]}>
                ...
                <View style={styles.progressSection}>
                  ...
                  <View style={[styles.progressBg, { backgroundColor: colors.border }]}>
                    <View
                      style={[
                        styles.progressFill,
                        { backgroundColor: tree.themeColor, width: `${selectedNode.progress}%` },
                      ]}
                    />
                  </View>
                </View>
                      ...
                      {prereqNames.map((prereq) => (
                        ...
                        >
                          <Ionicons
                            ...
                            size={14}
                            color={prereq.isUnlocked ? colors.success : colors.error}
                          />
                          <ThemedText
                            style={[
                              Typography.caption,
                ...
                {selectedNode.isUnlocked ? (
                  <Row
                    ...
                    align="center"
                    justify="center"
                    style={[styles.banner, { backgroundColor: withAlpha(colors.success, 0.09) }]}
                  >
                    <Ionicons name="checkmark-circle" size={20} color={colors.success} />
                    <ThemedText style={[Typography.subheading, { color: colors.success }]}>
                      Skill Unlocked!
                    </ThemedText>
                  </Row>
                ) : (
                  <View style={styles.actionsRow}>
                    ...
                    {canUnlockSelected ? (
                      ...
                      <Row
                        ...
                        align="center"
                        justify="center"
                        style={[styles.banner, { backgroundColor: withAlpha(colors.muted, 0.09) }]}
                      >
