      ...
      >
        ...
        <View style={styles.fieldGroup}>
          ...
          <Row gap="sm">
            <Row
              ...
              style={[
                styles.inputWrapper,
                {
                  ...
                  borderColor: form.codeError ? palette.error : palette.border,
                  flex: 1,
                },
              ]}
            >
              <TextInput
                ...
                value={form.code}
                onChangeText={form.handleCodeChange}
            ...
            <Clickable
              ...
              onPress={form.generateRandomCode}
            >
        ...
        <View style={styles.fieldGroup}>
          ...
          <PresetRow
            ...
            selected={form.creditAmount}
            onSelect={form.setCreditAmount}
            prefix={'\u00A3'}
          />
          <Row
            align="center"
        ...
        <View style={styles.fieldGroup}>
          ...
          >
            <TextInput
              style={[styles.input, { color: palette.text }]}
              value={form.maxUses}
              onChangeText={form.handleMaxUsesChange}
              placeholder="100"
              placeholderTextColor={palette.muted}
        ...
        <SurfaceCard style={styles.toggleCard}>
          <Row align="center" justify="space-between">
            ...
            <Switch
              value={form.onePerUser}
              onValueChange={form.setOnePerUser}
        ...
        <SurfaceCard style={styles.toggleCard}>
          <Row align="center" justify="space-between">
            ...
            <Switch
              ...
              onValueChange={form.setHasExpiry}
              trackColor={{ false: palette.border, true: palette.tint }}
              thumbColor={palette.surface}
            />
          </Row>
