        ...
        >
          ...
          {postType === 'event' && (
            <ClubPostEventFields
              ...
              onSetDate={(d) => onSetEventDate(d)}
              onChangeLocation={onSetEventLocation}
            />
          )}
      ...
      >
        ...
        <Clickable style={styles.toolbarButton} onPress={() => onPostTypeChange('event')}>
          <Ionicons
            ...
            size={22}
            color={postType === 'event' ? palette.tint : palette.muted}
          />
        </Clickable>
        <Clickable style={styles.toolbarButton} onPress={() => onPostTypeChange('announcement')}>
          <Ionicons
            ...
            size={22}
            color={postType === 'announcement' ? palette.tint : palette.muted}
          />
        </Clickable>
