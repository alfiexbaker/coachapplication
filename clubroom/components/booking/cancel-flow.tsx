      ...
      <View style={[styles.modalContainer, { backgroundColor: colors.background }]}>
        ...
        {loading ? (
          ...
          >
            ...
            {!isCoachCancelling && refundCalc && (
              <RefundBanner calculation={refundCalc} colors={colors} />
            )}
            ...
            <Row style={styles.buttonsRow}>
              <Clickable
                ...
                onPress={onClose}
              >
                <ThemedText style={[styles.keepButtonText, { color: colors.text }]}>
                  Keep Session
                </ThemedText>
              </Clickable>
              <Clickable
              ...
              >
                {submitting ? (
                  ...
                  <ThemedText style={[styles.confirmButtonText, { color: colors.surface }]}>
                    Confirm Cancel
                  </ThemedText>
                )}
              </Clickable>
