      ...
      <Animated.View entering={FadeInDown.delay(100).springify()}>
        <SurfaceCard style={styles.drillPreview}>
          <Row align="center" justify="space-between" style={{ marginBottom: Spacing.xs }}>
            ...
            >
              ...
              <ThemedText
                style={[
                  Typography.caption,
                  { color: categoryInfo.color, fontSize: scaleFont(Typography.caption.fontSize) },
                ]}
              >
                {categoryInfo.label}
              </ThemedText>
          ...
          <ThemedText
            ...
            style={[
              Typography.heading,
              { fontSize: scaleFont(Typography.heading.fontSize), marginBottom: Spacing.xs },
            ]}
          >
            {drill.title}
          </ThemedText>
          <Row gap="md" align="center">
            <Row gap="xxs" align="center">
              ...
              <ThemedText
                style={[
                  Typography.small,
                  { color: colors.muted, fontSize: scaleFont(Typography.small.fontSize) },
                ]}
              >
          ...
          <Row style={styles.athleteGrid}>
            {athletes.map((athlete) => {
              ...
              return (
                <Clickable
                  key={athlete.id}
                  onPress={() => onAthleteSelect(athlete)}
                  style={[
                    styles.athleteCard,
                    {
          ...
          <Row gap="xs" align="center" style={{ paddingVertical: Spacing.xs }}>
            ...
            <ThemedText
              style={[
                ...
                { color: colors.tint, fontSize: scaleFont(Typography.bodySemiBold.fontSize) },
              ]}
            >
              {formattedDate}
            </ThemedText>
      ...
      <Animated.View entering={FadeInDown.delay(250).springify()}>
        <View style={styles.section}>
          ...
          <Row gap="sm">
            {(
              [
                { value: 1, label: 'High', color: colors.error },
                { value: 2, label: 'Normal', color: colors.tint },
                { value: 3, label: 'Low', color: colors.muted },
              ] as const
            ).map((o) => {
              ...
              return (
                <Clickable
                  key={o.value}
                  onPress={() => onPrioritySelect(o.value)}
                  style={[
                    styles.priorityOption,
                    {
                      flex: 1,
                      backgroundColor: sel ? withAlpha(o.color, 0.09) : colors.surface,
