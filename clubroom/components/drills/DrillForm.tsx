          ...
          <TextInput
            style={[
              styles.input,
              {
                ...
                borderColor: form.errors.title ? palette.error : palette.border,
                color: palette.text,
              },
            ]}
        ...
        <View style={styles.fieldGroup}>
          ...
          <TextInput
            style={[
              ...
              {
                backgroundColor: palette.surface,
                borderColor: form.errors.description ? palette.error : palette.border,
                color: palette.text,
              },
            ]}
