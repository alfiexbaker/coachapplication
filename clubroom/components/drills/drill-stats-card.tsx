...
export const DrillStatsCard = memo(function DrillStatsCard({
  stats,
  colors,
  delay = 100,
}: DrillStatsCardProps) {
      ...
      <SurfaceCard style={styles.card}>
        <Row align="center" justify="space-between">
          ...
          <StatItem
            label="Overdue"
            value={stats.overdue}
            color={stats.overdue > 0 ? colors.error : colors.muted}
            colors={colors}
          />
          <View style={[styles.divider, { backgroundColor: colors.border }]} />
          <StatItem
          ...
          <View style={[styles.progressBarBg, { backgroundColor: colors.surfaceSecondary }]}>
            <View
              style={[
                ...
                { backgroundColor: colors.success, width: `${stats.completionRate}%` },
              ]}
            />
          </View>
        </View>
