    ...
    <View style={[styles.section, { backgroundColor: withAlpha(palette.tint, 0.04), borderColor: palette.border }]}>
      ...
      {[...existingTemplatesForDay]
        ...
        .map((t) => {
          ...
          return (
            <Row key={t.id} style={[styles.row, { backgroundColor: isCurrentEdit ? withAlpha(palette.tint, 0.08) : 'transparent' }]}>
...
const styles = StyleSheet.create({
  ...
  row: { alignItems: 'center', gap: Spacing.xs, paddingVertical: Spacing.xxs, paddingHorizontal: Spacing.xs, borderRadius: Radii.sm },
