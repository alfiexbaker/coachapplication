...
const styles = StyleSheet.create({
  ...
  durationBadge: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.xxs, paddingVertical: Spacing.xs, borderRadius: Radii.md },
  durationText: { ...Typography.smallSemiBold },
  errorText: { ...Typography.small },
  overlapWarning: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xxs, paddingVertical: Spacing.xs, paddingHorizontal: Spacing.sm, borderRadius: Radii.md },
