...
export const INVITE_TYPE_OPTIONS: InviteTypeOption[] = [
  {
    key: 'OPEN',
    label: 'Open Session',
    description: 'Open registration. Club sessions can also admit outside athletes.',
    icon: 'globe-outline',
    colorKey: 'success',
  },
  {
    key: 'CLOSED',
    label: 'Invite Only',
    description: 'Private registration for invited athletes or internal club groups.',
  ...
  },
  {
    key: 'SQUAD_ONLY',
    label: 'Squad Only',
    description: 'Private training for the selected squad.',
    icon: 'people-outline',
    colorKey: 'info',
  },
];
