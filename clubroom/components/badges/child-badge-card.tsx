...
export const ChildBadgeCard = memo(function ChildBadgeCard({
  award,
  highlighted,
  onRefresh,
}: ChildBadgeCardProps) {
    ...
    >
          ...
          <Row gap="xs" align="center" wrap>
            {award.badgeTier && (
              <Row style={[styles.metaPill, { backgroundColor: withAlpha(tierColor, 0.12) }]}>
                <ThemedText style={[Typography.micro, { color: tierColor }]}>
      ...
      <View style={{ gap: Spacing.xxs }}>
        <ThemedText
          ...
          style={[Typography.caption, { textTransform: 'uppercase', letterSpacing: 0.5 }]}
        >
          Reason
        </ThemedText>
      ...
      {award.note && (
        <View
          style={[
            styles.noteSection,
            {
              backgroundColor: withAlpha(colors.tint, 0.03),
        ...
        >
          <Row gap="xs" align="center">
            ...
            <ThemedText type="defaultSemiBold" style={[Typography.caption, { color: colors.tint }]}>
              Coach&apos;s Note
            </ThemedText>
          </Row>
          <ThemedText style={[Typography.bodySmall, { fontStyle: 'italic' }]}>
            &quot;{award.note}&quot;
          </ThemedText>
        </View>
      )}
