      ...
      <View style={styles.profileInfo}>
        <Row style={styles.nameRow}>
          ...
          {coach.badges?.includes('Verified') && (
            <Row style={[styles.verifiedBadge, { backgroundColor: withAlpha(palette.success, 0.09) }]}>
        ...
        {coach.badges && coach.badges.length > 0 ? (
          <Row style={styles.badgesRow}>
            {coach.badges.map((badge, i) => (
              <Row key={i} style={[styles.badgePill, { backgroundColor: withAlpha(palette.success, 0.09) }]}>
...
const styles = StyleSheet.create({
  ...
  headerButtons: { position: 'absolute', top: Spacing.sm, left: Spacing.sm, right: Spacing.sm, justifyContent: 'space-between' },
  ...
  verifiedBadge: { alignItems: 'center', gap: Spacing.xs / 2, paddingHorizontal: Spacing.xs, paddingVertical: Spacing.xs / 2, borderRadius: Radii.pill },
  ...
  badgePill: { alignItems: 'center', gap: Spacing.xs / 2, paddingHorizontal: Spacing.xs, paddingVertical: Spacing.xs / 2, borderRadius: Radii.pill },
  ctaRow: { gap: Spacing.sm, marginTop: Spacing.sm },
  bookButton: { flex: 1, height: Components.button.height, alignItems: 'center', justifyContent: 'center', gap: Spacing.xs, borderRadius: Components.button.borderRadius },
