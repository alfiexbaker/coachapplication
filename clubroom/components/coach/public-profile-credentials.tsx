...
export const PublicProfileCredentials = memo(function PublicProfileCredentials({ coach }: PublicProfileCredentialsProps) {
          ...
          {coach.experiences.map((exp, i) => (
            <View key={i} style={styles.expItem}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <ThemedText style={[Typography.body, { color: palette.muted }]}>{exp.organization}</ThemedText>
