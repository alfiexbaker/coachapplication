      ...
      <View style={styles.list}>
        {squads.map((squad) => {
          ...
          return (
            <Clickable
              key={squad.id}
              onPress={() => onToggle(squad.id)}
              style={[
                styles.row,
                {
                  borderColor: isIn ? colors.tint : colors.border,
                  backgroundColor: isIn ? withAlpha(colors.tint, 0.03) : colors.surface,
                },
              ]}
            >
              <View
              ...
              <View
                style={[styles.toggle, { backgroundColor: isIn ? colors.tint : colors.border }]}
              >
