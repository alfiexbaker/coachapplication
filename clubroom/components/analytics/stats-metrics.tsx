  ...
  return (
    <View style={styles.progressMetric}>
      <Row style={styles.progressMetricHeader}>
        {icon && (
          <View
            style={[styles.progressMetricIcon, { backgroundColor: withAlpha(accentColor, 0.07) }]}
          >
  ...
  return (
    <SurfaceCard style={styles.metricsSummaryCard}>
      ...
      {highlight && (
        ...
        >
          {highlight.icon && (
            <Ionicons name={highlight.icon} size={24} color={highlight.color || palette.tint} />
          )}
          <View style={styles.metricsSummaryHighlightContent}>
            <ThemedText
              type="heading"
              style={[
                styles.metricsSummaryHighlightValue,
        ...
        {metrics.map((metric, index) => {
          ...
          return (
            <Animated.View
              ...
              style={[styles.metricsSummaryItem, { borderColor: palette.border }]}
            >
              ...
              {metric.trend && trendColor && (
                <Row
                  style={[
                    styles.metricsSummaryTrend,
                    { backgroundColor: withAlpha(trendColor, 0.07) },
                  ]}
                >
                  <Ionicons
