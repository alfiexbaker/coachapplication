            ...
            return (
              <Animated.View key={skill.skillName} entering={FadeInDown.delay((catIndex * 100) + (index * 50)).springify()} style={styles.skillRow}>
                ...
                <Row style={styles.skillRowRight}>
                  ...
                  <Row style={[styles.skillRowTrend, { backgroundColor: withAlpha(changeColor, 0.09) }]}>
...
const styles = StyleSheet.create({
  ...
  skillRowTrend: { alignItems: 'center', gap: Spacing.micro, paddingHorizontal: Spacing.xxs, paddingVertical: Spacing.micro, borderRadius: Radii.sm, minWidth: 58 },
