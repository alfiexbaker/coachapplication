...
beforeEach(async () => {
  await coachAnalyticsService.resetToMockData();
});

describe('Coach Analytics Service', () => {
  describe('getCoachAnalytics', () => {
    test('should return analytics for a known coach', async () => {
      const analytics = await coachAnalyticsService.getCoachAnalytics('coach1');
    ...
    test('should return default analytics for unknown coach', async () => {
      const analytics = await coachAnalyticsService.getCoachAnalytics('unknown_coach');
    ...
    test('should respect period parameter', async () => {
      ...
      for (const period of periods) {
        const analytics = await coachAnalyticsService.getCoachAnalytics('coach1', period);
    ...
    test('should return correct trend direction based on revenue change', async () => {
      ...
      const coach1Analytics = await coachAnalyticsService.getCoachAnalytics('coach1');
      ...
      const coach2Analytics = await coachAnalyticsService.getCoachAnalytics('coach2');
  ...
  describe('getRevenueChart', () => {
    test('should return revenue data points', async () => {
      const revenueData = await coachAnalyticsService.getRevenueChart('coach1', 'MONTH');
    ...
    test('should return different data points for different periods', async () => {
      const weekData = await coachAnalyticsService.getRevenueChart('coach1', 'WEEK');
      const monthData = await coachAnalyticsService.getRevenueChart('coach1', 'MONTH');
      const yearData = await coachAnalyticsService.getRevenueChart('coach1', 'YEAR');
  ...
  describe('getRetentionMetrics', () => {
    test('should return retention metrics', async () => {
      const metrics = await coachAnalyticsService.getRetentionMetrics('coach1');
    ...
    test('should return default metrics for unknown coach', async () => {
      const metrics = await coachAnalyticsService.getRetentionMetrics('unknown_coach');
  ...
  describe('getCancellationPatterns', () => {
    test('should return cancellation statistics', async () => {
      const stats = await coachAnalyticsService.getCancellationPatterns('coach1');
  ...
  describe('getPeakHours', () => {
    test('should return peak hours data', async () => {
      const peakHours = await coachAnalyticsService.getPeakHours('coach1');
  ...
  describe('getTopSkills', () => {
    test('should return top skills data', async () => {
      const topSkills = await coachAnalyticsService.getTopSkills('coach1');
    ...
    test('should return empty array for unknown coach', async () => {
      const topSkills = await coachAnalyticsService.getTopSkills('unknown_coach');
  ...
  describe('getSessionStats', () => {
    test('should return session statistics', async () => {
      const stats = await coachAnalyticsService.getSessionStats('coach1');
    ...
    test('should return default stats for unknown coach', async () => {
      const stats = await coachAnalyticsService.getSessionStats('unknown_coach');
  ...
  describe('Multiple Coaches', () => {
    test('should return different data for different coaches', async () => {
      const coach1Analytics = await coachAnalyticsService.getCoachAnalytics('coach1');
      const coach2Analytics = await coachAnalyticsService.getCoachAnalytics('coach2');
      const coach3Analytics = await coachAnalyticsService.getCoachAnalytics('coach3');
