...
- generic personal posting, generic rate-coach selection, and the standalone community group directory/create hub have been removed; retained updates, private group detail, and reviews now stay tied to club communication, squad coordination, and booking-linked proof
- appearance customization, smart-slot suggestions, and the separate analytics route tree have been removed; retained settings now support account, trust, communication, scheduling, and discovery operations, while development and money insight routes stay inside development, roster, earnings, and invoices
