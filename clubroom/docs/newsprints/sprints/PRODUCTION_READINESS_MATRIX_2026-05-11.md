...
10. Community group message send/read writes plus notification read/dismiss/clear/preference state are backend-owned in API mode; remaining community/messaging/notification write risk is feed/comment writes and message delete/direct-message send.
