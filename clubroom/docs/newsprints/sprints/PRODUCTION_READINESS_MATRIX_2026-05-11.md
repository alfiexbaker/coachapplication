...
| Direct bookings                      | `/v1/bookings*`                                        | Create/list/detail db-backed; lifecycle scaffolded | Cancel/reopen audit, idempotency, conflict/version checks, deny tests, mirror cleanup                         |
...
3. Booking cancel/reopen still need audit, idempotency keys, conflict/version checks, and transactional persistence; create now has idempotency and transactional persistence but still needs broader deny/audit proof.
