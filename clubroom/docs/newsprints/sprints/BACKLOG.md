...
| API-01 | Make sensitive family, medical, booking, and safeguarding flows backend-authoritative instead of mock-first | Trust/Safety/Ops + Booking/Revenue | NOW | `docs/SOURCE_OF_TRUTH.md`, `docs/backend-api/ROUTE_INVENTORY_V1.md`, `docs/backend-api/AUTHZ_AUDIT_AND_SECURITY.md` |
