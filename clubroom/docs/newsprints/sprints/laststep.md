...
3. Continue backend-authoritative delivery burn-down with the next high-risk slice: full invite repository extraction, club admin operations, comment reactions, direct-message/message-delete authority, broader profile/storefront proof cleanup, or guardian permission/versioning.
