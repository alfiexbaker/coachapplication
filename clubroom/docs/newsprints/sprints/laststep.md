...
3. Continue backend-authoritative delivery burn-down with the next high-risk slice: full invite repository extraction, club admin operations, comment reactions, richer message moderation/versioning, broader profile/storefront proof cleanup, or guardian permission/versioning.
