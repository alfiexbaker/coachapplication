...
3. Continue `PROD-API-02` by moving the next backend-authoritative delivery slice: attendance/proof linkage or recurring invoice adjustment semantics.
