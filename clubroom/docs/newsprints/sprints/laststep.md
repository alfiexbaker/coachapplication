...
1. Continue `PROD-API-01`.
2. Begin booking authority hardening: direct booking confirmation, `POST /v1/bookings`, booking local mirror removal, idempotency, audit, and denial tests.
