...
3. Continue `PROD-API-02` by moving the next backend-authoritative delivery slice: richer media/feedback proof linkage, group-session cancellation/refund effects, or full invite repository/audit hardening.
