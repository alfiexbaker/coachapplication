...
3. Continue `PROD-API-02` by moving the next backend-authoritative delivery slice: full invite repository/audit hardening, group-session cancel fan-out, or review/rebook proof authority.
